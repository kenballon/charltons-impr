...
function get_newsletters_posts_sc2()
{
...
add_action('wp_ajax_get_newsletters_posts', 'get_newsletters_posts_sc2');
add_action('wp_ajax_nopriv_get_newsletters_posts', 'get_newsletters_posts_sc2');
